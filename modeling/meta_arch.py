...
class build_transformer(nn.Module):
    def __init__(self, num_classes, cfg, camera_num, view_num, factory, feat_dim):
        ...
        self.in_planes = feat_dim  # 输入特征维度
        ...
        if cfg.MODEL.TRANSFORMER_TYPE == 'vit_base_patch16_224':
            ...
            if cfg.MODEL.FROZEN: # False
                lora_train(self.base)
        elif cfg.MODEL.TRANSFORMER_TYPE == 'ViT-B-16':
            self.clip = 1
            self.sie_xishu = cfg.MODEL.SIE_COE # 1.0
            ...
            dinov3_path = cfg.MODEL.DINOV3_PRETRAIN_PATH if hasattr(cfg.MODEL, 'DINOV3_PRETRAIN_PATH') and cfg.MODEL.DINOV3_PRETRAIN_PATH != '' else None
            self.base = DINOv3Encoder(pretrained_path=dinov3_path)
