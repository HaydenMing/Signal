...
_C.MODEL.Gram_Loss_weight = 0.15
_C.MODEL.PAT_Loss_weight = 0.1
_C.MODEL.MoE_Loss_weight = 0.1
...
# Multi-Modal Memory Collaboration (MMC)
_C.MODEL.USE_MMC = False          # whether to use multi-modal memory bank
_C.MODEL.MMC_LOSS_WEIGHT = 1.0    # weight of MMC loss
_C.MODEL.MEMORY_MOMENTUM = 0.5    # momentum for memory update (0.5 = balanced, 0.2 was too aggressive)
...
_C.MODEL.MMC_REDUCE_TRIPLET = False  # if True, zero out triplet loss when MMC is enabled (like CLIMB-ReID)
...
_C.DATALOADER.NUM_WORKERS = 6  # This may be affected by the order of data reading
...
_C.OUTPUT_DIR = "./test"
_C.ckpt_save_path = 'baseline'
_C.ckpt_test_path = 'test_RNT'
