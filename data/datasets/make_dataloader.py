...
def make_dataloader(cfg):
    ...
    if 'triplet' in cfg.DATALOADER.SAMPLER:
        ...
        else:  # train_collate_fn： imgs, pids, camids, viewids,_
            train_loader = DataLoader(
                train_set, batch_size=cfg.SOLVER.IMS_PER_BATCH,
                sampler=RandomIdentitySampler(dataset.train, cfg.SOLVER.IMS_PER_BATCH, cfg.DATALOADER.NUM_INSTANCE,cfg.SOLVER.SEED),
